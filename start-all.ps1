...
Start-Process powershell -WorkingDirectory "c:\Users\parve\OneDrive\Documents\EyeZora\backend\backend" -ArgumentList "-NoExit", "-Command", "npm run dev"
...
Start-Process powershell -WorkingDirectory "c:\Users\parve\OneDrive\Documents\EyeZora\backend\backend" -ArgumentList "-NoExit", "-Command", ".\venv\Scripts\uvicorn main:app --host 127.0.0.1 --port 8000 --reload"

# 3. Start Next.js Frontend
Write-Host "[3/3] Starting Next.js Frontend (Port 3000)..." -ForegroundColor Yellow
Start-Process powershell -WorkingDirectory "c:\Users\parve\OneDrive\Documents\EyeZora\frontend\frontend" -ArgumentList "-NoExit", "-Command", "npm run dev"
